        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{settings.alamat}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{settings.telepon}</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-12 h-12 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 rounded-xl flex items-center justify-center text-white hover:opacity-80 transition-opacity"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-black rounded-xl flex items-center justify-center text-white hover:opacity-80 transition-opacity"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-8 bg-gray-100 rounded-xl p-6">
              ...
              <p className="text-sm text-gray-500 mt-4">
                *WhatsApp support tersedia 24 jam
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-8">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-primary hover:bg-primary-dark text-white py-4 rounded-xl font-semibold transition-all hover:shadow-lg"
              >
                Kirim Pesan
              </button>
            </form>
